...
Java_com_estebanposada_dummiewhisper_whisper_NativeMethodsKt_createTFLiteEngine(JNIEnv *env,
                                                                                jclass clazz) {
...
Java_com_estebanposada_dummiewhisper_whisper_NativeMethodsKt_loadModel(JNIEnv *env, jclass clazz,jlong nativePtr,jstring modelPath,jboolean isMultilingual) {
...
Java_com_estebanposada_dummiewhisper_whisper_NativeMethodsKt_freeModel(JNIEnv *env, jclass clazz,jlong nativePtr) {
    TFLiteEngine *engine = reinterpret_cast<TFLiteEngine *>(nativePtr);
    engine->freeModel();
    delete engine;
}
...
Java_com_estebanposada_dummiewhisper_whisper_NativeMethodsKt_transcribeBuffer(JNIEnv *env,jclass clazz,jlong nativePtr,jfloatArray samples) {
    TFLiteEngine *engine = reinterpret_cast<TFLiteEngine *>(nativePtr);
...
JNIEXPORT jstring JNICALL
Java_com_estebanposada_dummiewhisper_whisper_NativeMethodsKt_transcribeFile(JNIEnv *env,jclass clazz,jlong nativePtr,jstring waveFile) {
    TFLiteEngine *engine = reinterpret_cast<TFLiteEngine *>(nativePtr);
